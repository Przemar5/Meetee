...
namespace Meetee\Libs\Security\Validators\Compound\Topics;
...
class TopicIdValidator extends CompoundValidator
{
	public function __construct()
	{
		...
		$validators[] = ValidatorFactory::createExistsValidator('topics', 'id');
